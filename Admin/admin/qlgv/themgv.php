 ...
 $conn = mysqli_connect('localhost', 'root','', 'thion');
	if(isset($_POST['add'])){
		...
		if($num == 0){
			...
			$sql2 = "INSERT INTO giaovien (magv, hoTen, gioitinh, sodienthoai, quequan, trinhdo, idmon, lop, email, taikhoan, matkhau) VALUES ('$magv', '$hoten', '$gioitinh', '$sodienthoai', '$quequan', '$trinhdo', '$idmon', '$lop', '$email', '$magv', '$magv')";
					...
					<div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="trinhdo" placeholder="Trình độ"  class="form-control">
                            ...
                            <div class="form-group">
                            	<label>Lớp</label>
                                <!-- <input required="true" class="form-control" id="" name="lop" placeholder="Lớp" value=""/> -->
                                <select name="lop" placeholder="Lớp"  class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" readonly=""  class="form-control" id="" name="taikhoan" value="Tài khoản ( Mã giáo viên )"/>
                            </div>
                            <div class="form-group">
                            	<label>Mật khẩu</label>
                                <input type="text" readonly="" class="form-control" id="" name="matkhau" value="Tài khoản ( Mã giáo viên )"/>
                            </div>
                        </div>
                    </div>
                    <button type="button" class="btn btn-success" href = "http://localhost:70/ThiTN/Admin/admin/qlgv/gv.php" onclick="back()">Trỏ lại</button>
                    <script>
                    	function back(){
                    		history.back();
                    	}
