<?php
    ...
    // 	echo '<script type="text/javascript">'; 
	   ...
	   // 	echo '</script>';
    	if(mysqli_query($conn, $sql)){
			echo "<script>alert('Xóa kỳ thi thành công..'); window.location='http://localhost:70/ThiTN/Teacher/exammanagement.php'</script>";
    	}
    	else{
			echo "<script>alert('FAIL! Xóa không thành công.'); window.location='http://localhost:70/ThiTN/Teacher/exammanagement.php'</script>";
    	}
    	mysqli_close($conn);
    }
?>