			...
			?>
					...
					<div class="w3-row w3-section">
			  			<div class="w3-col" style="width:50px">
			  				<input class="w3-radio" type="radio" name="dapAn" value="1" <?php if($row['dapandung'] == $row['dapan1']){?>checked<?php } ?>>
			  			</div>
			    		<div class="w3-rest">
					...
					<div class="w3-row w3-section">
			  			<div class="w3-col" style="width:50px">
			  				<input class="w3-radio" type="radio" name="dapAn" value="2" <?php if($row['dapandung'] == $row['dapan2']){?>checked<?php } ?>>
			  			</div>
			    		<div class="w3-rest">
					...
					<div class="w3-row w3-section">
			  			<div class="w3-col" style="width:50px">
			  				<input class="w3-radio" type="radio" name="dapAn" value="3" <?php if($row['dapandung'] == $row['dapan3']){?>checked<?php } ?>>
			  			</div>
			    		<div class="w3-rest">
					...
					<div class="w3-row w3-section">
			  			<div class="w3-col" style="width:50px">
			  				<input class="w3-radio" type="radio" name="dapAn" value="4" <?php if($row['dapandung'] == $row['dapan4']){?>checked<?php } ?>>
			  			</div>
			    		<div class="w3-rest">
