...
$('#btnNote').click(function() {
    ...
    function checkResult() {  
        ...
        let score = 0;
          $('#questions div.row').each(function(k, v){
              let id = $(v).find('h5').attr('dapan');
              let question = questions.find(x=>x.id == );
    ...
    success:function(data){
      ...
      $.each(questions,function(k,v){
        ...
        d+=    '<label class = "A"><input type="radio" class="A" name = "'+v['dapan']+'"><span class="text-danger">A: </span>'+v['dapan1']+'</label>';
        d+=   '</div>';
        d+=  ' <div class="radio col-md-12">';
        d+=     '<label class = "B"><input type="radio" class="B" name = "'+v['dapan']+'"><span class="text-danger">B: </span>'+v['dapan2']+'</label>';
        d+=   '</div>';
        d+=   '<div class="radio  col-md-12">';
        d+=     '<label class = "C"><input type="radio"  class="C" name = "'+v['dapan']+'"><span class="text-danger">C: </span>'+v['dapan3']+'</label>';
        d+=   '</div>';
        d+=   '<div class="radio col-md-12">';
