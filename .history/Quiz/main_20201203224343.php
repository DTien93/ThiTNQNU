  ...
  <div class="container">
    <div class="panel-group">
      <div class="panel panel-primary">
        <div class="panel-heading">Danh sách câu hỏi
            <p id = "time"></p>
        </div>
    ...
    function checkResult() {  
        ...
        let score = 0;
          $('#questions div.row').each(function(k, v){
              ...
              $('#question_'+id+' > fieldset > div > label.'+answer + note).css("background-color", "orange") ;
          });        
          $('#fail').text('Số câu sai của bạn là : '  + fail + '/'  + total );
          $('#mark').text('Số câu đúng của bạn là : '  + mark + '/'  + total );
          $('#score').text('Điểm của bạn là  : '  + score);
    }
