...
$('#btnNote').click(function() {
    ...
    success:function(data){
      ...
      $.each(questions,function(k,v){
        ...
        d+=    '<label class = "A"><input type="radio" class="A" name = "'+'"><span class="text-danger">A: </span>'+v['dapan1']+'</label>';
        d+=   '</div>';
        d+=  ' <div class="radio col-md-12">';
        d+=     '<label class = "B"><input type="radio" class="B" name = "'+'"><span class="text-danger">B: </span>'+v['dapan2']+'</label>';
        d+=   '</div>';
        d+=   '<div class="radio  col-md-12">';
        d+=     '<label class = "C"><input type="radio"  class="C" name = "'+'"><span class="text-danger">C: </span>'+v['dapan3']+'</label>';
        d+=   '</div>';
        d+=   '<div class="radio col-md-12">';
        d+=     '<label class = "D"><input type="radio" class="D" name = "'+'"><span class="text-danger">D: </span>'+v['dapan4']+'</label>';
        d+=   '</div>';
        d+=  '</fieldset>';
        d+=  '</fieldset>';
        d+= '</div>';
