...
<?php
    ...
    $sql3 = "INSERT INTO thongtinbailam(idbailam, iddethi, mahs, diem) VALUES ( '".$_SESSION['idkythi']."',  '".$_SESSION['iddethi']."' 
                                                                                                                                         '".$_SESSION['taikhoan']."')";
    
    echo $_SESSION['idkythi'];
    echo $_SESSION['iddethi'];
    echo $_SESSION['taikhoan'];
    echo $_SESSION['score1'] =  $('#mark').text('Bạn đã trả lời đúng được :  ' + mark +' ' + 'câu');
    // echo $_SESSION['diemthi'];
...
$('#btnNote').click(function() {
    ...
    function checkResult() {  
        ...
        let score = 0;
          ...
          $_SESSION['score1'] =  $('#mark').text('Bạn đã trả lời đúng được :  ' + mark +' ' + 'câu');
