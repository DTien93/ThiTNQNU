...
<?php
    ...
    $_SESSION['diemthi'] = $_SESSION['diem']; 

    // $sql3 = "INSERT INTO thongtinbailam (idbailam , iddethi, mahs, diem) VALUES (9, 8, 2, 10 )";
    $sql3 = " INSERT INTO thongtinbailam (idbailam, iddethi, mahs, diem) VALUES (2, '".$_SESSION['iddethi']."','".$_SESSION['taikhoan']."','".$_SESSION['taikhoan']."', 9  )";
    
    // echo $_SESSION['idkythi'];
    // echo $_SESSION['iddethi'];
...
$('#btnNote').click(function() {
    ...
    $_SESSION['diem'] = $('#score').text('Số điểm bạn đạt được : '  + score); 
