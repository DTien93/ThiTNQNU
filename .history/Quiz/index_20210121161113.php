...
<body>
  ...
  <?php
  $conn = $conn = mysqli_connect('localhost', 'root','', 'thion');
    $sql = ("SELECT * FROM dethi where idkythi =  '".$_SESSION['idkythi']."'  ") ;
    // $sql1 = ("SELECT * FROM dethi where iddethi = '".$_SESSION['iddethi']."' ");
    $result2 = mysqli_query($conn, $sql);
    $row2 = mysqli_fetch_array($result2);
    $sql2 = ("SELECT * FROM thongtinbailam where iddethi = '".$_SESSION['id']."' ");
    $diembailam = $_SESSION['diem'];
    $conn = mysqli_connect('localhost', 'root','', 'thion');
    $sql3 = "INSERT INTO thongtinbailam ()VALUES('$diembailam')";
