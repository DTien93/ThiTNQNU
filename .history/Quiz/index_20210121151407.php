...
<body>
  ...
  <?php
     $_SESSION['diem'] = $_SESSION['diem'];
    $sql = "insert into thongtinbailam values diem = $_SESSION['diem]";
  ?>
...
$('#btnNote').click(function() {
    ...
    function checkResult() {  
        ...
        $_SESSION['caudung'] =  $('#mark').text('Bạn đã trả lời đúng được :  ' + mark +' ' + 'câu');
        $_SESSION['causai'] =  $('#fail').text('Số câu sai của bạn là : '  + fail + ' '+  'câu');
