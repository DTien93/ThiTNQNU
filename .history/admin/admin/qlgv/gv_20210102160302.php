  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="http://localhost:70/ThiTN/Manager/Logins/Login/index.html"><span class="glyphicon glyphicon-log-in"></span> Đăng xuất</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-1 sidenav">
      <p><a href="http://localhost:70/ThiTN/Admin/admin/qlhs/hs.phpa">Học sinh</a></p>
      <p><a href="http://localhost:70/ThiTN/Admin/admin/qlgv/gv.php">Giáo viên</a></p>
...
foreach ($giaovienList as $gv) {
  echo '<tr>
      ...
      <td>'.$gv['taikhoan'].'</td>
      <td>'.$gv['matkhau'].'</td>
      <td><button class="btn btn-warning" onclick=\'window.open("input.php?id='.$gv['id'].'","_self")\'>Edit</button></td>
      <td><button class="btn btn-danger" onclick="deleteGiaovien('.$gv['id'].')">Delete</button></td>
    </tr>';
}
?>
          </tbody>
