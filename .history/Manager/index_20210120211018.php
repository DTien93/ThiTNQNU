...
<body class="overlay-scrollbar">
				...
				<div class="avt dropdown">
						<div>
							<span>
									...
									<?php 
												if(isset($_SESSION['taikhoan']) && $_SESSION['taikhoan'] && $_SESSION['hoTen']){
													echo 'Xin chào : '.$_SESSION['taikhoan']['hoTen']."<br/>";
											}
											else{
					...
					<ul id="user-menu" class="dropdown-menu">
						...
						<li  class="dropdown-menu-item">
							<a href="http://localhost:70/ThiTN/Manager/Logins/Login/index.html" class="dropdown-menu-link">
								<div>
	...
	<div class="sidebar">
		<ul class="sidebar-nav">
			...
			<li class="sidebar-nav-item">
				<a href="http://localhost:70/ThiTN/Manager/Thongtinbailam/index.html" class="sidebar-nav-link ">
					<div>
					<i class="fas fa-book-reader"></i>
					</div>
					<span>
