    ...
    <div class="panel-group">
      <div class="panel panel-primary">
        ...
        <p>Danh sách câu hỏi</p>
            <p id = "time" class = "col-sm text-left"></p>
        </div>
...
$('#btnNote').click(function() {
    ...
    success:function(data){
      ...
      $.each(questions,function(k,v){
        ...
        d+=   '<h5 style="font-weight:bold;" id="'+v['idcauhoi']+'"> <span class="text-danger">Câu '+index+': </span>'+v['cauhoi']+'</h5>';
        d +=   '<fieldset>';
        d+=   '<div class="radio col-md-12 ">';
        d+=    '<label class = "A"><input type="radio" class="A" name = "'+v['id']+'"><span class="text-danger">A: </span>'+v['dapan1']+'</label>';
        d+=   '</div>';
        d+=  ' <div class="radio col-md-12">';
        d+=     '<label class = "B"><input type="radio" class="B" name = "'+v['id']+'"><span class="text-danger">B: </span>'+v['dapan2']+'</label>';
        d+=   '</div>';
        d+=   '<div class="radio  col-md-12">';
        d+=     '<label class = "C"><input type="radio"  class="C" name = "'+v['id']+'"><span class="text-danger">C: </span>'+v['dapan3']+'</label>';
        d+=   '</div>';
        d+=   '<div class="radio col-md-12">';
        d+=     '<label class = "D"><input type="radio" class="D" name = "'+v['id']+'"><span class="text-danger">D: </span>'+v['dapan4']+'</label>';
        d+=   '</div>';
        d+=  '</fieldset>';
