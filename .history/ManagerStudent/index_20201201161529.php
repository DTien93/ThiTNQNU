...
<body class="overlay-scrollbar">
		...
		<ul class="navbar-nav nav-right">
			...
			<li class="nav-item avt-wrapper">
				<div class="avt dropdown">
					<img src="assets/tua.jpg" alt="User image" class="dropdown-toggle" data-toggle="user-menu">
	...
	<div class="sidebar">
		<ul class="sidebar-nav">
			...
			<li class="sidebar-nav-item">
				<a href="http://localhost:70/ThiTN/Quiz/main.php" class="sidebar-nav-link active">
					<div>
