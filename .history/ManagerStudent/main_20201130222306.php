...
<head>
	...
	<link rel="stylesheet" href="./preview/stylee.css">
	<!-- End import lib -->
					...
					<ul id="user-menu" class="dropdown-menu">
						<li  class="dropdown-menu-item">
							...
							<li class="sidebar-nav-item">
								<a href="./ManagerStudent/LoginStudent/Login/index.html" class="sidebar-nav-link">
								<div>
										<i class="fas fa-user">Thoát</i> 
									</div>
								</a>
							</li>
					</ul>
