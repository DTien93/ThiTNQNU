        ...
        <div class="container">
            <div class="card card-container">
                ...
                <form class="form-signin">
                    ...
                    <input type="user" name = "taikhoan" id="inputEmail" class="form-control" placeholder="Tài Khoản" required autofocus>
                    <input type="pass" name="matkhau" id="inputPassword" class="form-control" placeholder="Mật khẩu" required>
