	...
	<div class="navbar">
		...
		<ul class="navbar-nav nav-right">
			...
			<li class="nav-item avt-wrapper">
				<div class="login">
				<?php 
							if (isset($_SESSION['hoten']) && $_SESSION['taikhoan']){
								echo 'Bạn đã đăng nhập với tên là '.$_SESSION['taikhoan']."<br/>";
								echo 'Click vào đây để <a href="/ThiTN/ManagerStudent/LoginStudent/Login/index.html">Logout</a>';
							}
							else{
								echo 'Xin chào, Văn Tiến';
							}
							?>
	...
	<div class="sidebar">
		<ul class="sidebar-nav">
			<li class="sidebar-nav-item">
				<a href="./InformationStudent/Information/php/main.php" class="sidebar-nav-link">
					<div>
			...
			<li  class="sidebar-nav-item">
				<a href="/ThiTN/Quiz/index.html" class="sidebar-nav-link">
					<div>
