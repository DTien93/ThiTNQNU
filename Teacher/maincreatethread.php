<?php
	...
	if(isset($_POST["createthread"])){
		...
		if($row1 = mysqli_fetch_array($result1)){
			...
			echo "<script>alert('Tạo đề thi thành công.'); window.location='http://localhost:70/ThiTN/Teacher/checkthread.php'</script>";
		...
		if($row1 = mysqli_fetch_array($result1)){
			...
			echo "<script>alert('Cập nhật đề thi thành công.'); window.location='http://localhost:70/ThiTN/Teacher/thread.php'</script>";
		}
	}
