<?php
	...
	if(isset($_POST["create"]))
	{
		...
		{
			echo "<script>alert('Kỳ thi đã tồn tại!.'); window.location='http://localhost:70/ThiTN/Teacher/createexam.html'</script>";
		}
		else
		{
			...
			if(mysqli_query($conn, $sql1)){
				echo "<script>alert('Tạo kỳ thi thành công!.'); window.location='http://localhost:70/ThiTN/Teacher/createexam.html'</script>";
			}
			else{
				echo "<script>alert('FAIL!.'); window.location='http://localhost:70/ThiTN/Teacher/createexam.html'</script>";
			}
